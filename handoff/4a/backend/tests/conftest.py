    ...
    with eng.begin() as connection:
        ...
        connection.execute(
            text(
                ...
                # Day 4A action tables. Listed explicitly, ahead of the Day 3 tables
                # they reference, so identities restart and each test sees predictable
                # simulation/recommendation/action IDs.
                "audit_events, actions, approvals, recommendations, "
                "counterfactual_simulations, agent_tool_calls, agent_runs, "
